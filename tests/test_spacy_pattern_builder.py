...
def test_tokens_not_connected_error():
    doc = doc1
    match_examples = [
        util.idxs_to_tokens(
            doc, [19, 20, 21, 27]
...
def test_duplicate_tokens_error():
    doc = doc1
    match_examples = [
        util.idxs_to_tokens(
            doc, [0, 1, 1, 3]
...
def test_yield_node_level_pattern_variants():
...
def test_yield_pattern_permutations():
    doc = doc1
